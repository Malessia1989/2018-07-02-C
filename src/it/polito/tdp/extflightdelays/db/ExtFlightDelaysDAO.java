...
public class ExtFlightDelaysDAO {
	...
	public List<Rotta> getRotte(Map<Integer,Airport> idMap, Integer NumCompagnie ){
		
		String sql="select f.ORIGIN_AIRPORT_ID id1, f.DESTINATION_AIRPORT_ID id2, count(*) as peso\r\n" + 
				"from flights f\r\n" + 
		...
		try {
			...
			while (rs.next()) {
				...
				Rotta rotte=new Rotta(partenza, destinazione, rs.getInt("peso"));
				result.add(rotte);
